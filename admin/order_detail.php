...
error_reporting(1);
$id3=$_GET['id'];
// print_r("SELECT * FROM order_master where order_status='Delivered' AND id='$id3'");
// die();
$delid = $_GET['delid'];
...
if ($delid != ""){
    ...
    $upsql = "delete from product where id={$delid}";            
...
if ($inactive != ""){
    ...
    $upsql = "UPDATE product SET status='0' where id={$inactive}";            
...
if ($active != ""){
    ...
    $upsql = "UPDATE product SET status='1' where id={$active}";            
                        ...
                        <li class="nav-item dropdown ml-10">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <a class="dropdown-item" href="logout.php"><i data-feather="power"
                                    ...
                                    Logout</a>
                                <div class="dropdown-divider"></div>
                                <div class="pl-4 p-3"><a href="../index.php" class="btn btn-sm btn-info">View
                                        Website</a></div>
                            </div>
                        </li>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                               <?php
                                                ...
                                                $sqlfetch = "SELECT * FROM order_master where order_status='Delivered' AND id='$id3'";
// print_r($sqlfetch);
// die();
                                                ...
                                                $row = mysqli_fetch_assoc($sqlfetch);
                                                    ...
                                                    $id=$row['id'];
                                                    $sqlfetch1 = "SELECT * FROM user_login where id='$row[user_id]'";
                                                    $sqlfetch1 = mysqli_query($conn,$sqlfetch1);
                                                    $row1 = mysqli_fetch_array($sqlfetch1);

                                                    $sqlfetch11 = "SELECT * FROM cart where session_id='$row[session_id]'";
                                                    $sqlfetch11 = mysqli_query($conn,$sqlfetch11);
                                                    while($row11 = mysqli_fetch_assoc($sqlfetch11)){
                                                        
                                                        $sqlfetch12 = "SELECT * FROM product where id='$row11[product]'";
                                                        $sqlfetch12 = mysqli_query($conn,$sqlfetch12);
                                                        $row12 = mysqli_fetch_array($sqlfetch12);
                                            ...
                                            <tr>
                                                ...
                                                <td>₹
                                                <?php echo $row12['price']*$row11['quantity']; ?>.00</td>
