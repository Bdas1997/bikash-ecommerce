                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                               <?php
                                                ...
                                                $sqlfetch = "SELECT * FROM order_master where order_status='ordered'";

                                                $result1 = mysqli_query($conn,$sqlfetch);
                                                ...
                                                while ($row = mysqli_fetch_assoc($result1))
                                                {
                                                    ...
                                                    $sqlfetch12 = mysqli_query($conn,$sqlfetch11);
                                                    $row1 = mysqli_fetch_assoc($sqlfetch12);

                                            ?>
                                            <tr>
                                                <td><?php echo $row['order_id']; ?></td>
                                                <td><?php echo $row1['name']; ?>/<?php echo $row1['phone']; ?></td>
                                                <td><?php echo $row1['city']; ?>/<?php echo $row1['pin']; ?></td>
                                                <td>₹ <?php echo round($row['totalprice']); ?>.00</td>
                                                <td><button class="btn btn-success" style="color:white;"><?php echo $row['order_status']; ?></button></td>
                                                <td><a href="assignorder.php?id=<?php print $row['id']; ?>" class="btn btn-danger" style="color:white;">Assign</a> </td>
                                                <td>
                                                        
                                                        
                <a href="order_details.php?id=<?php print $row['id']; ?>" class="btn btn-danger" style="color:white;">View</a> </td>
