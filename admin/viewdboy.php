                ...
                <nav class="sidebar-nav">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="productadd.php"
                                aria-expanded="false"><i class="fas fa-plus"></i><span
                                    ...
                                    <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="pro_mng.php"
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Delivery Boy Details</h4>
...
?>
                                            <tr>
                                                ...
                                                <td><img src="upload/<?php echo $row["image"];?>" style="height: 100px"></td>
                                                <td class="text-center">
                                                        
                                                        
                <a href="edit_dboy.php?id=<?php echo $row['id']; ?>"><i class="fas fa-edit"></i></a> |
                <a href="delete_dboy.php?id=<?php echo $row['id']; ?>"><i class="fas fa-trash-alt"></i></a></td>
