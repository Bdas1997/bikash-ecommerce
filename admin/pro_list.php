...
{
    $sqlfetch1 = "SELECT * FROM brand where id='$row[brand]'";

$sqlfetch1 = mysqli_query($conn,$sqlfetch1);
$row1 = mysqli_fetch_array($sqlfetch1);
$sqlfetch2 = "SELECT * FROM pcategory where id='$row[category]'";
...
?>
                         ...
                         <span class="badge badge-danger"><?php echo $row['status']; ?>
                                                            ...
                                                            <?php }?></td>
                                                            <td> <a href="productadd.php?id=<?php echo $row['id']; ?>"><i class="fas fa-edit" style="color:#000;"></i></a> |
