...
if ($delid != ""){
    ...
    $upsql = "delete from offer where id={$delid}";            
...
<li class="list-divider"></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Offer Details</h4>
            ...
            <div class="container-fluid">
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['offerproductname']; ?></td>
              ...
              <a href="offer.php?id=<?php print $row['id']; ?>"><i class="fas fa-edit"></i></a> |

                                                            <a href="?delid=<?php print $row['id']; ?>" onclick ="return confirm('Are you sure to delete ?')"><i class="fas fa-trash-alt"></i></a>
