            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Out Of Delivery</h4>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="?delid=<?php print $row['id']; ?>" class="btn btn-sm bg-success" style="color:white;" onclick ="return confirm('Are you sure to Change the product status To Delivered ?')"><i class="fa fa-close" aria-hidden="true"></i> Out for Delivery</a></td>
