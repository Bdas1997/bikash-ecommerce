        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            ...
            <ul class="nav-shop">
              ...
              <li class="nav-item"><button><a href="cart.php"><i class="ti-shopping-cart"></i><span class="nav-shop__circle"></span></a></button> </li>
              <li class="nav-item"><a class="button button-header" href="login.php">Login/Signup</a></li>
            </ul>
          </div>
        </div>
      </nav>
