...
?>
        ...
        <div class="col-xl-9 col-lg-8 col-md-7">
          ...
          <section class="lattest-product-area pb-40 category-list">
            <div class="row">
               <?php
$query1="select * from product where category='$id' ";
$result=mysqli_query($conn,$query1);
while($row=mysqli_fetch_assoc($result)){
      ...
      <div class="row mt-30">
        ...
        <div class="col-sm-6 col-xl-4 mb-4 mb-xl-0">
          <div class="single-search-product-wrapper">
            <?php
$query1="select * from product where category='10' ";
$result=mysqli_query($conn,$query1);
while($row=mysqli_fetch_assoc($result)){
...
?>
        ...
        <div class="col-sm-6 col-xl-4 mb-4 mb-xl-0">
          <div class="single-search-product-wrapper">
            <?php
$query1="select * from product where category='3' ";
$result=mysqli_query($conn,$query1);
while($row=mysqli_fetch_assoc($result)){
...
?>
        ...
        <div class="col-sm-6 col-xl-4 mb-4 mb-xl-0">
          <div class="single-search-product-wrapper">
            <?php
$query1="select * from product where category='5' ";
$result=mysqli_query($conn,$query1);
while($row=mysqli_fetch_assoc($result)){
